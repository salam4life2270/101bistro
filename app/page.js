...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between py-24 mb-10 w-full relative">
     <Imagee />
     <Slider />
     <History />
      <h1 className="text-center text-2xl mb-4 z-20 p-8" >101 Bistro</h1>
      <p className="text-center text-lg mb-4 z-20">101b@101bistro.is</p>
      <div>
  <h2 className="text-center mt-4 mb-2 text-2xl z-20">Check Out Our Reviews</h2>
