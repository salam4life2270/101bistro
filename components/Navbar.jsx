  ...
  return (
    <div style={{backgroundColor: `${color}`}} className='fixed left-0 top-0 w-full z-20 ease-in duration-300'>
        <div className='max-w-[1240] m-auto flex justify-between items-center p-4 text-white'>
            <Link href='/'>
            <h1 style={{color: `${textColor}`}} className='font-bold text-4xl'>101 Bistro</h1>
            </Link>
            ...
            <div className={nav ? 'sm:hidden absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center w-full h-screen bg-black text-center ease-in duration-300' : 'sm:hidden absolute top-0 left-[-100%] right-0 bottom-0 flex justify-center items-center w-full h-screen bg-black text-center ease-in duration-300'}>
                <ul>
                  ...
                  <li className='p-4 text-4xl hover:text-gray-500'>
                      <Link href='/menus' onClick={handleNav}>Menus</Link>
                  </li> 
                  <li className='p-4 text-4xl hover:text-gray-500'>
                      <Link href='/order' onClick={handleNav}>Order Online</Link>
                  </li> 
                  <li className='p-4 text-4xl hover:text-gray-500'>
                      <Link href='/jobs' onClick={handleNav}>Jobs</Link>
                  </li> 
                  <li className='p-4 text-4xl hover:text-gray-500'>
